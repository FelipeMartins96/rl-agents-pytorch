...
REPLAY_SIZE = 100000  # Maximum Replay Buffer Sizer
...
EXP_GRAD_RATIO = 10  # Number of collected experiences for every grad step
...
if __name__ == "__main__":
    ...
    tb_path = os.path.join('runs', ENV + '_' + current_time + '-' + args.name)
    ...
    try:
        while True:
            ...
            new_samples = 0
            while new_samples < EXP_GRAD_RATIO:
                exp = exp_queue.get()
                if exp is None:
